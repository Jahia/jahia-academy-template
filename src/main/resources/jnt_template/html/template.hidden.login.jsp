...
<c:set var="loginMenuULClass" value="navbar-nav ms-auto text-end"/>
<c:choose>
    <c:when test="${renderContext.loggedIn}">
        <ul class="${loginMenuULClass}">
            <li class="nav-item dropdown">
                <a class="nav-item nav-link dropdown-toggle me-md-2 link-dark" href="#" id="list-${currentNode.identifier}"
                   data-bs-toggle="dropdown" aria-expanded="false" role="button">
                        ${currentUser.username}
                </a>
                <ul class="dropdown-menu text-small" aria-labelledby="list-${currentNode.identifier}">
