        ...
        <c:if test="${not empty moduleMap.paginationActive and moduleMap.totalSize > 0 and moduleMap.nbPages > 0}">
            ...
            <c:choose>
                ...
                <ul class="pagination ${layout} ${align}">
                    ...
                    <div class="page-item${empty moduleMap.currentPage or moduleMap.currentPage le 1 ? ' disabled' : ''}">
                    ...
                    <div class="page-item${moduleMap.currentPage ge moduleMap.nbPages ? ' disabled' : ''}">
